 ...
 * @version 创建时间：2011-12-15 上午11:58:36
 * 解析xml
 */
public class XMLParse {
	 ...
	 */
	public Plugin parsePluginXML(InputStream ins) throws IOException, XmlPullParserException{
        ...
        while(event != XmlPullParser.END_DOCUMENT){
            ...
            case XmlPullParser.START_TAG:   
                ...
                //功能描述结点
                	...
                	plugin.setDescription(parser.getAttributeValue(_NAME_SPACE, _NAME));
                }
                
                //功能描述结点
                else if(_FEATURE.equals(parser.getName())){   
                	feature.setFeatureName(parser.getAttributeValue(_NAME_SPACE, _NAME));
                }
                
                //方法描述结点
                else if(_METHOD.equals(parser.getName())){  
                	
                	featureMethod.setMethodName(parser.getAttributeValue(_NAME_SPACE, _NAME));
                	if("true".endsWith(parser.getAttributeValue(_NAME_SPACE, _NEEDCTX)))
